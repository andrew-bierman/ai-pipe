...
describe("SUPPORTED_PROVIDERS", () => {
  ...
  test("includes all expected providers", () => {
    const expected: ProviderId[] = ["openai", "anthropic", "google", "perplexity", "xai", "mistral", "groq", "deepseek", "cohere", "openrouter", "huggingface"];
...
describe("resolveModel", () => {
  ...
  const providerCases: Array<{ provider: ProviderId; model: string; envVar: string; expectedModelId: string }> = [
    ...
    { provider: "huggingface", model: "huggingface/meta-llama/Llama-3.3-70b-Instruct", envVar: "HF_TOKEN", expectedModelId: "meta-llama/Llama-3.3-70b-Instruct" },
  ];
